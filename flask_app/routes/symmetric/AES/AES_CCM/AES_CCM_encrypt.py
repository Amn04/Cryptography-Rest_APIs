...
class Aes_encrypt_ccm(Resource):
    ...
    def get(self):
        '''This is get method API for AES Encryption Algorithm in CCM mode. In CCM mode of 
        ...
        statement. If key is not provided then this function is generating 128bit
